...
const Content = () => {
  ...
  return (
    <div className='h-[calc(100vh-50px)] w-full border-2 border-[#a2a7b0] shadow-lg mx-1 rounded'>
<div className="h-[54px] w-full  justify-between rounded flex items-center">
      ...
      <div
        className="h-[calc(100vh-108px)] w-full p-4 border-t border-[#56595e] bg-[#f5f5f5] overflow-y-scroll scroll-container"
      >
