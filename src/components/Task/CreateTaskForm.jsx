    ...
    <div className="bg-gray-50 shadow-inner px-6 py-4 rounded-xl h-[460px] border border-gray-200 max-w-2xl mx-auto overflow-y-auto">
      ...
      <div className="mb-2">
        <input
          ...
          className={`w-full px-3 py-2 border font-bold rounded-md text-sm text-black focus:ring-1 ${
            errors.title ? 'border-red-500 ring-red-400' : 'border-gray-300 focus:ring-violet-500'
          }`}
        />
      ...
      <div className="mb-2">
        <textarea
          ...
          onChange={handleChange}
          rows={3}
          className={`w-full px-3 py-2 border rounded-md text-sm text-black resize-none focus:ring-1 ${
            errors.description ? 'border-red-500 ring-red-400' : 'border-gray-300 focus:ring-violet-500'
          }`}
        />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
        <div>
          ...
          <select
            ...
            className={`w-full px-3 py-2 border rounded-md text-sm text-black ${
              errors.assignee ? 'border-red-500 ring-red-400' : 'border-gray-300 focus:ring-violet-500'
            }`}
          >
        ...
        <div>
          ...
          <select
            ...
            onChange={handleChange}
            className={`w-full px-3 py-2 border rounded-md text-sm text-black ${
              errors.projectId ? 'border-red-500 ring-red-400' : 'border-gray-300 focus:ring-violet-500'
            }`}
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            className={`w-full px-3 py-2 border rounded-md text-sm text-black ${
              errors.time ? 'border-red-500 ring-red-400' : 'border-gray-300 focus:ring-violet-500'
            }`}
          />
        </div>
        <div>
      ...
      <div className="flex justify-end border-t pt-4">
        <button
          ...
          disabled={loading}
          className={`bg-violet-600 text-white px-5 py-2 rounded-md text-sm font-medium transition ${
