...
const ProjectList = ({ projects, isCreator, onProjectDeleted }) => {
    const [confirmDel, setConfirmDel] = useState(null); // Track project for deletion
    ...
    const handleDeleteProject = async (projectId) => {
        toast.promise(
            ...
            .then(() => {
                onProjectDeleted(projectId); // Remove project from state
            });

        setConfirmDel(null); // Close confirmation dialog after deletion
    };
                        ...
                        >
                            ...
                            {isCreator && (
                                <ImBin
                                    ...
                                    onClick={() => setConfirmDel(project.id)}
                                />
                            )}
