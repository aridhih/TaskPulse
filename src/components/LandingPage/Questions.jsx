...
const Questions = () => {
  return (
    <section class="bg-white w-full pt-40">
    <div class="p-8">
      <h2
        class="mb-6 text-3xl font-extrabold tracking-tight text-center text-gray-900 ">
        ...
        <div id="accordion-flush" data-accordion="collapse"
          ...
          <h3 id="accordion-flush-heading-1">
            <button type="button" class="flex items-center justify-between w-full py-5 font-medium text-left text-gray-900 bg-white border-b border-gray-200" data-accordion-target="#accordion-flush-body-1" aria-expanded="true" aria-controls="accordion-flush-body-1">
              ...
              <svg data-accordion-icon="" class="w-6 h-6 rotate-180 shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 011.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 010-1.414z" clip-rule="evenodd"></path></svg>
            </button>
          </h3>
          <div id="accordion-flush-body-1" class="" aria-labelledby="accordion-flush-heading-1">
            <div class="py-5 border-b border-gray-200">
              ...
              <p class="text-gray-500">Check out this guide to learn how to <a href="#"
                class="text-purple-600 hover:underline">get started</a> and start
          ...
          <h3 id="accordion-flush-heading-2">
            <button type="button" class="flex items-center justify-between w-full py-5 font-medium text-left text-gray-500 border-b border-gray-200" data-accordion-target="#accordion-flush-body-2" aria-expanded="false" aria-controls="accordion-flush-body-2">
              ...
              <svg data-accordion-icon="" class="w-6 h-6 shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 011.414 0L10 10.586l3.293-3.293a1 1 011.414 1.414l-4 4a1 1 010-1.414z" clip-rule="evenodd"></path></svg>
            </button>
          </h3>
          <div id="accordion-flush-body-2" class="hidden" aria-labelledby="accordion-flush-heading-2">
            <div class="py-5 border-b border-gray-200">
              <p class="mb-2 text-gray-500">Landwind is first conceptualized and designed
              ...
              <p class="text-gray-500">Check out the <a href="#"
                class="text-purple-600 hover:underline">Figma design system</a>
          ...
          <div id="accordion-flush-body-3" class="hidden" aria-labelledby="accordion-flush-heading-3">
            <div class="py-5 border-b border-gray-200">
              ...
              <ul class="pl-5 text-gray-500 list-disc">
                <li><a href="#" class="text-purple-600 hover:underline">Landwind
                  Pro</a></li>
