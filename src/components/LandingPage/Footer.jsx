        ...
        <footer className="bg-white w-full">
            <div className="p-10">
                ...
                <div className="text-center">
                    ...
                    <img src="public\logo.png" alt="logo" className="w-20 h-20 mr-3" />
                        <span className="block text-sm text-center text-gray-500">© 2024-2025 TasPulse. All Rights Reserved.</span>                  
                    </div>                       
